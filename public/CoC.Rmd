...
author: "Initial version by Melbourne Open Research Network, minor updates for NZ by Matt Williams"
...
The New Zealand Open Research Network (NZORN) seeks to promote open practices, and as part of this vision is committed to the provision of a safe, inclusive, welcoming and harassment-free atmosphere to all. 
...
All parties to NZORN activities are subject to this code of conduct, this includes attendees, speakers, sponsors, and committee members and its provisions apply to both physical and non-physical spaces (e.g. on NZORN associated social media platforms).

The New Zealand Open Research Network (NZORN) seeks to promote open practices. We are committed to the provision of a safe, inclusive, welcoming and harassment-free atmosphere to all irrespective of race, gender, sexual orientation, ability, religious beliefs (or lack thereof), political beliefs, age, physical appearance, body size or socioeconomic status. 

It is expected that parties to NZORN activities:
